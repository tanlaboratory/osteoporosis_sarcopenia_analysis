...
## Using RRA to intergrate one consistent gene list for each disease. We treat OS and SA seperately.
```{r}
...
## Annotate w/ the freq. for each gene and output RRA results 
```{r}
...
### Intersection of RRA results for OS and SA
```{r}
